...
export async function getSteps() {
  const headers = {
    Referer: 'https://panel.walk15.lt/',
    Origin: 'https://panel.walk15.lt',
    Host: 'api.panel.walk15.lt',
  };

  const result = await axios.post(
    'https://api.panel.walk15.lt/api/v1/report.getPublic',
    {
      challengeId: 'FZnCYo8sT_GLvgmiILVpEVKmuAo9ut_-WNlX',
      dateRangeType: 'challenge',
      from: '2024-09-02',
      to: '2024-12-02',
      page: 1,
      pageSize: 10,
  ...
  return result.data.data.participants;
}
